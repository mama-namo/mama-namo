...
-----------------------------------------------------------
   Author    : Mama
   GitHub    : https://github.com/mama-namo
   Note      : Tool Create Mama
   Note      : Tool No  Seel 0 $
   Note      : telegram:@i4m_mama 
-----------------------------------------------------------
                     """

CorrectUsername = 'mama'
CorrectPassword = 'mama'
os.system('clear')
print logo
loop = 'true'
while loop == 'true':
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;97m[Check-point] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass111
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;97m[Checkpoint] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass222
                    cps = open('anggaxd/clone.txt', 'a')
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;97m[Checkpoint] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass333
                        cps = open('anggaxd/clone.txt', 'a')
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;97m[Check-point] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass444
                            cps = open('anggaxd/clone.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;97m[Check-point] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass555
                                cps = open('anggaxd/clone.txt', 'a')
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;97m[Check-point] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass666
                                    cps = open('anggaxd/clone.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;97m[Check-point] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass777
                                        cps = open('anggaxd/clone.txt', 'a')
                                        ...
                                        if 'access_token' in q:
                                            ...
                                            print '\x1b[1;97m[Check-point] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass888
                                            cps = open('anggaxd/clone.txt', 'a')
